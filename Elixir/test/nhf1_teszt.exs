eval =
  ...
  # Create an asynchronous task for the evaluation
task = Task.async(fn -> eval.("test18d.txt", t18s) end)

# Wait for 5 seconds for the task to finish
result = Task.await(task, 5000) # 5000 milliseconds or 5 seconds

# Check if the task finished or timed out
case result do
  nil -> IO.puts "The evaluation timed out after 5 seconds!"
  _ -> IO.puts "---" # Proceed as usual
end
